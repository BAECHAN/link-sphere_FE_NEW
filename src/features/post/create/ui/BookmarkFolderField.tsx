...
import { useBookmarkFolderField } from '@/features/post/create/hooks/useBookmarkFolderField';

/**
 * 링크 등록 폼의 북마크 폴더 선택 필드.
 *
 * entities/bookmark/folder/ui/FolderPickerModal 를 features/post/bookmark/ui/BookmarkFolderModal
 ...
 */
export function BookmarkFolderField() {
  const {
    bookmark,
    folderIds,
    open,
