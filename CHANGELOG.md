...
- `infra` Storybook을 기존 S3+CloudFront 배포로 공개 호스팅
  ...
  (`.github/workflows/deploy-storybook.yml`(신규), `.github/workflows/deploy.yml`, `.github/workflows/ci.yml`, `infra/cloudfront-functions/spa-fallback.js`, `docs/DEPLOY.md`, `docs/CI-CHECK-GATE.md`, `docs/DECISIONS.md`, `docs/plans/2026-09-20-storybook-public-deploy.md`(신규), `README.md`)
