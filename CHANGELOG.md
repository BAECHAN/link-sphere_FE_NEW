...
- `shared` 드롭다운 메뉴가 열려 있어도 스크롤되고, 스크롤하면 닫히게 변경
  ...
  (`src/shared/ui/atoms/dropdown-menu.tsx`, `e2e/dropdown-menu-scroll.spec.ts`(신규), `e2e/dropdown-menu-scroll.mobile.spec.ts`(신규), `e2e/bookmark-folder-menu-press-drag.spec.ts`, `docs/DECISIONS.md`, `docs/plans/2026-09-24-dropdown-scroll-dismiss.md`(신규))
