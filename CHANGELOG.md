...
- `shared` 모바일에서 Select 트리거를 다시 탭하면 닫혔다가 다시 열리던 문제 수정
  ...
  (`src/shared/ui/atoms/select.tsx`, `src/shared/ui/atoms/select.test.tsx`(신규), `src/shared/hooks/useClickGuard.ts`, `docs/plans/2026-09-24-select-reopen-guard.md`(신규))
