...
| 기본 강조             | `--primary`                     | `bg-primary`, `text-primary-foreground`                       | 주요 버튼, CTA (2026-09-21부터 `var(--brand)` 참조 — 아래 브랜드 행 참고)                                                                                                                                                   |
| 보조                  | `--secondary`                   | `bg-secondary`, `text-secondary-foreground`                   | 보조 버튼                                                                                                                                                                                                                   |
| 브랜드                | `--brand`, `--brand-2`          | `bg-brand`/`text-brand-foreground`, `from-brand`/`to-brand-2` | CTA 그라데이션(`bg-linear-to-br from-brand to-brand-2`). `--primary`가 직접 참조하므로 단독 사용은 드묾                                                                                                                     |
